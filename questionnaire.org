...
#+end_src
#+begin_src lisp :results value file :file questionnaire.html
  ...
  (spinneret:with-html-string
    (with-page () (questionnaire-1 "/submit"
                                   (:ask "How old are you?"
                                    :group "age"
                                    :choices (:radio "18-24" "25-34" "35-44" "45-54" "55+"))
                                   (:ask "Your Gender?"
                                    :group "gender"
                                    :choices (:radio "Male" "Female" "Non-Binary" "Prefer not to say"))
                                   ...
                                   (:ask "Which of the following devices do you regularly use to browse the internet? (Select all that apply)"
                                    :group "devices"
                                    :choices (:checkbox "Desktop" "Laptop" "Tablet" "Smartphone")))))
#+end_src
